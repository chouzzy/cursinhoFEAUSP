...
const CreateDonationSchema_1 = require("./CreateDonationSchema");
function checkBody(donationData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield CreateDonationSchema_1.donationSchema.validate(donationData, {
                abortEarly: false,
            });
