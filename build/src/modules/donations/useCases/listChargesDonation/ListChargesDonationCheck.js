...
const ListChargesDonationSchema_1 = require("./ListChargesDonationSchema");
function checkBody(donationID) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield ListChargesDonationSchema_1.listChargesDonationSchema.validate({ donationID }, {
                abortEarly: false,
            });
