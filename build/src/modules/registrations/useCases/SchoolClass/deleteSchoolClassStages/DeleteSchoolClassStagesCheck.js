...
const DeleteSchoolClassStagesSchema_1 = require("./DeleteSchoolClassStagesSchema");
function checkBody(schoolClassStagesData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield DeleteSchoolClassStagesSchema_1.createSchoolClassStagesSchema.validate(schoolClassStagesData, {
                abortEarly: false,
            });
