...
const RefundStudentSchema_1 = require("./RefundStudentSchema");
function checkBody(studentID, chargeID) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield RefundStudentSchema_1.refundStudentSchema.validate({ studentID, chargeID }, {
                abortEarly: false,
            });
