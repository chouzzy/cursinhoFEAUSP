...
const ListChargesStudentsSchema_1 = require("./ListChargesStudentsSchema");
function checkBody(studentID) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield ListChargesStudentsSchema_1.listChargesStudentSchema.validate({ studentID }, {
                abortEarly: false,
            });
