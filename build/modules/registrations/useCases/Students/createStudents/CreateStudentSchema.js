...
const studentSchema = (0, yup_1.object)({
    ...
    purcharsedSubscriptions: (0, yup_1.object)({
        ...
        paymentMethod: (0, yup_1.string)().required("O método de pagamento é obrigatório").oneOf(['card']),
        currency: (0, yup_1.string)().required("É necessário especificar o tipo de moeda: 'brl' ").oneOf(['brl'])
