...
const ListStudentsUseCase_1 = require("./ListStudentsUseCase");
class ListStudentsController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const listStudentsUseCase = new ListStudentsUseCase_1.ListStudentsUseCase(studentsRepository);
            const response = yield listStudentsUseCase.execute(query);
