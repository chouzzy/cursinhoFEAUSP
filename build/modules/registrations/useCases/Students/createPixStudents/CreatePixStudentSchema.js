...
exports.studentPixSchema = void 0;
const yup_1 = require("yup");
const studentPixSchema = (0, yup_1.object)({
    ...
    purcharsedSubscriptions: (0, yup_1.object)({
        ...
        paymentMethod: (0, yup_1.string)().required("Informe a forma de pagamento").oneOf(['PIX'], 'A única forma de pagamento válida é PIX')
    }).required('É necessário comprar ao menos uma inscrição para prosseguir')
});
exports.studentPixSchema = studentPixSchema;
