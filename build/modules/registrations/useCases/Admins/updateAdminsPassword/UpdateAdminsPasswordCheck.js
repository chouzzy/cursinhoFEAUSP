...
const UpdateAdminsPasswordSchema_1 = require("./UpdateAdminsPasswordSchema");
//////
function checkBody(adminData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield UpdateAdminsPasswordSchema_1.updateAdminPasswordSchema.validate(adminData, {
                abortEarly: false,
            });
