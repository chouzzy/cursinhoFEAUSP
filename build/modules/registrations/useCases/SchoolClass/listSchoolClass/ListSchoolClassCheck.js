...
const ListSchoolClassSchema_1 = require("./ListSchoolClassSchema");
function checkBody({ page, pageRange, status }) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield ListSchoolClassSchema_1.listSchoolClassSchema.validate({ page, pageRange, status }, {
                abortEarly: false,
            });
...
function ErrorValidation(listSchoolClass) {
    return __awaiter(this, void 0, void 0, function* () {
        function checkIfIsAError(listSchoolClass) {
