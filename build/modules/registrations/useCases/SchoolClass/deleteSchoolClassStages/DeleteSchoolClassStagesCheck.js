...
const CreateSchoolClassStagesSchema_1 = require("../createSchoolClassStages/CreateSchoolClassStagesSchema");
function checkBody(schoolClassStagesData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield CreateSchoolClassStagesSchema_1.createSchoolClassStagesSchema.validate(schoolClassStagesData, {
                abortEarly: false,
            });
