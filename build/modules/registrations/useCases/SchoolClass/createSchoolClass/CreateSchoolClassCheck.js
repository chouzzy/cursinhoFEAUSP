...
const CreateSchoolClassSchema_1 = require("./CreateSchoolClassSchema");
function checkBody(schoolClassData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield CreateSchoolClassSchema_1.createSchoolClassSchema.validate(schoolClassData, {
                abortEarly: false,
            });
