...
const DeleteSchoolClassDocsSchema_1 = require("./DeleteSchoolClassDocsSchema");
function checkBody(schoolClassDocsData) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield DeleteSchoolClassDocsSchema_1.createSchoolClassDocsSchema.validate(schoolClassDocsData, {
                abortEarly: false,
            });
