...
const RefundDonationSchema_1 = require("./RefundDonationSchema");
function checkBody(donationID, chargeID) {
    return __awaiter(this, void 0, void 0, function* () {
        // check body properties
        try {
            const yupValidation = yield RefundDonationSchema_1.refundDonationSchema.validate({ donationID, chargeID }, {
                abortEarly: false,
            });
...
function ErrorValidation(createdDonation) {
    return __awaiter(this, void 0, void 0, function* () {
        function checkIfIsAError(createdDonation) {
