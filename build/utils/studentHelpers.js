...
exports.createStudent = exports.updateStudentPaymentInProgress = exports.getStripeDonationCustomerID = exports.getStripeStudentCustomerID = exports.getStudentAlreadyActive = exports.getStudent = exports.checkSchoolClassExists = exports.getSchoolClassPrice = exports.createStudentPix = exports.updateStudentPix = exports.getEfiCredentials = exports.getStudentByCPForRG = exports.checkIfPixIsExpired = exports.checkIfPixAlreadyConcluded = void 0;
...
function checkSchoolClassExists(schoolClassID) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
exports.checkSchoolClassExists = checkSchoolClassExists;
function getStudent(cpf, rg) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const searchedStudent = yield prisma_1.prisma.students.findFirst({
                where: {
...
function getStudentAlreadyActive(studentID, schoolClassID) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const studentAlreadyActive = yield prisma_1.prisma.students.findFirst({
                where: {
                    id: studentID,
                    purcharsedSubscriptions: {
                        some: {
...
exports.getStudentAlreadyActive = getStudentAlreadyActive;
function getStripeStudentCustomerID(studentData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const stripeCustomer = new StripeCustomer_1.StripeCustomer();
            let stripeSearchedCustomerID = yield stripeCustomer.searchCustomer(studentData.cpf, null);
            //  CRIA CLIENTE NO STRIPE CASO NÃO EXISTA
            if (!stripeSearchedCustomerID) {
                let stripeCreatedCustomerID = yield stripeCustomer.createCustomerStudent(studentData);
...
exports.getStripeStudentCustomerID = getStripeStudentCustomerID;
function getStripeDonationCustomerID(donationData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const stripeCustomer = new StripeCustomer_1.StripeCustomer();
            ...
            if (cpf) {
                stripeSearchedCustomerID = yield stripeCustomer.searchCustomer(cpf, null);
            }
            if (cnpj) {
                stripeSearchedCustomerID = yield stripeCustomer.searchCustomer("NDA", cnpj);
            }
            //  CRIA CLIENTE NO STRIPE CASO NÃO EXISTA
            if (!stripeSearchedCustomerID) {
                let stripeCreatedCustomerID = yield stripeCustomer.createCustomerDonations(donationData);
                stripeSearchedCustomerID = stripeCreatedCustomerID;
            }
            return stripeSearchedCustomerID;
        }
...
exports.getStripeDonationCustomerID = getStripeDonationCustomerID;
function updateStudentPaymentInProgress(searchedStudent, schoolClassID) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const findStudentBySchoolClassID = yield prisma_1.prisma.students.findFirst({
                where: {
...
exports.updateStudentPaymentInProgress = updateStudentPaymentInProgress;
function createStudent(studentData, stripeCustomerID, schoolClassID) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const createdStudent = yield prisma_1.prisma.students.create({
